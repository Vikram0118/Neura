        ...
        <div className='max-w-7xl mx-auto flex px-6 py-3 items-center justify-between'>
          <div className=''>
            <a href="#" className='flex gap-5 items-center' onClick={() =>{ 
              ...
              <p className='text-lg md:text-2xl text-white'>NEURA 2023</p>
            </a>
          </div>

           <div className='hidden sm:block '>
              <div className='flex gap-5 text-xl text-gold'>
                <a href="#aboutus"><button className={` rounded-lg px-2 py-1 hover:text-green `} onClick={() => setActive('aboutus')}>ABOUT US</button></a>
                <a href="#events"><button className={` rounded-lg px-2 py-1 hover:text-green `} onClick={() => setActive('events')}>EVENTS</button></a>
              </div>
          </div>
