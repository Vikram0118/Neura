...
import {logo, soloSinging} from '../import';
  ...
  return (
    <div className='bg-white'>
        ...
        <div className='flex max-w-6xl h-auto flex-col items-center justify-start mt-8 gap-10 mx-2 sm:mx-auto'>
          <IndividualTitle text='SOLO SINGING' />
          <div className='sm:flex'>
            <img src={soloSinging} alt="" className='svg-hidden sm:w-96 sm:h-96'/>
            <div className='flex flex-col mx-2 text-left gap-2 '>
              ...
              <div>
                <ul className='flex flex-col gap-2 text-b ase sm:text-lg my-3'> 
                  <li>1. PARTICIPANTS CAN SING FOR A MAXIMUM OF 3 MINUTES. </li>
                  <li>2. SONG KAROKE IS ALLOWED. </li>
                  <li>3. JUDGING WILL BE BASED ON VOICE CLARITY, VOICE RANGE AND STAGE PRESENCE. </li>
                  <li>4. DECISION MADE BY THE JUDGES WILL BE FINAL IN ALL ASPECTS. </li>
                </ul>
              </div>
              <div className='bg-backGround rounded-xl py-2 px-5 space-y-3'>
                <div className='text-base sm:text-lg'><span className='font-medium text-lg sm:text-xl'>REGISTRATION</span> : <a href='https://forms.gle/UNGFpQxTpkzmRAQo9' target='_blank' className='hover:text-orange'><span className='text-red hover:text-green underline'>LINK</span></a> ( SPOT REGISTRATION ALSO AVAILABLE )</div>
                <div className='text-base sm:text-lg'><span className='font-medium text-lg sm:text-xl'>FOR FURTHER DETAILS CONTACT</span> : AISWARYADEVI V - 9361471616</div>
              </div>
            </div>
          </div>
      </div>
