            ...
            <div className='flex flex-col mx-2 text-left gap-2 '>
              ...
              <div>
                <ul className='flex flex-col gap-2 text-b ase sm:text-lg my-3'> 
                  <li>1. EACH TEAM SHOULD HAVE 2 TO 3 MEMBERS. </li>
                  <li>2.  </li>
              ...
              <div className='bg-backGround rounded-xl py-2 px-5 space-y-3'>
                ...
                <div className='text-base sm:text-lg'><span className='font-medium text-lg sm:text-xl'>FOR FURTHER DETAILS CONTACT</span> : BHUVANA - 9345576605</div>
              </div>
            </div>
          </div>
      </div>
