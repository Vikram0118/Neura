...
import {logo, VVGsvg} from '../import';
  ...
  return (
    <div className='bg-white'>
        ...
        <div className='flex max-w-6xl h-auto flex-col items-center justify-start mt-8 gap-10 mx-2 sm:mx-auto'>
          <IndividualTitle text='VARIETY VARIETY - GROUP' />
          <div className='sm:flex'>
            <img src={VVGsvg} alt="" className='svg-hidden sm:w-96 sm:h-96'/>
            <div className='flex flex-col mx-2 text-left gap-2 '>
              ...
              <div className='text-base sm:text-lg'><span className='font-medium text-lg sm:text-xl'>PRIZE AMOUNT</span> : INR 6500 </div>
              <div>
                <ul className='flex flex-col gap-2 text-b ase sm:text-lg my-3'> 
                  <li>1. EACH TEAM CAN HAVE UPTO 8 MEMBERS. </li>
                  <li>2. KAROKE WILL BE ALLOWED. </li>
                  <li>3. PARTICIPANTS ARE REQUESTED TO BRING THEIR KAROKE.</li>
                  <li>4. JUDGING WILL BE PURELY BASED ON THE PERFORMANCE AND SKILLS.</li>
              ...
              <div className='bg-backGround rounded-xl py-2 px-5 space-y-3'>
                <div className='text-base sm:text-lg'><span className='font-medium text-lg sm:text-xl'>REGISTRATION</span> : <a href='https://forms.gle/eggua91oJrZh7jeYA' target='_blank' className='hover:text-orange'><span className='text-red hover:text-green underline'>LINK</span></a> ( SPOT REGISTRATION ALSO AVAILABLE )</div>
                <div className='text-base sm:text-lg'><span className='font-medium text-lg sm:text-xl'>FOR FURTHER DETAILS CONTACT</span> : ARAVINDAN M - 8838967951</div>
              </div>
            </div>
          </div>
      </div>
